...
public class HardlightGreathelmGlowmask : PlayerDrawLayer
{
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
		...
		if (drawPlayer.armor[12].type == ModContent.ItemType<HardlightGreathelm>() || (drawPlayer.armor[12].type == ItemID.None && drawPlayer.armor[2].type == ModContent.ItemType<HardlightGreathelm>()))
		{
