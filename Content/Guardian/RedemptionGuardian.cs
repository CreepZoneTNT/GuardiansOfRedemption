...
using GuardiansOfRedemption.Content.Guardian.Buffs;
using GuardiansOfRedemption.Content.Guardian.Weapons.Standards;
...
using GuardiansOfRedemption.Content.Guardian.Projectiles.Armor;
